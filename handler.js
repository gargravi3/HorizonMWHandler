...
Game.Play = function() {
  ...
  if (FPS == "-") {
    ...
    Context.ReplaceLinesInTextFile(txtPath, [Context.FindLineNumberInTextFile(txtPath, "seta 0xF264C46C", Nucleus.SearchType.StartsWith) + '|seta 0xF264C46C "' + FPS + '"']);
  }
  ...
  Context.ReplaceLinesInTextFile(txtPath, cfgLines);
